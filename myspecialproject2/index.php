        ...
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          <form action="LOGIN2.PHP" method="post">
            ...
            <div class="form-outline mb-4">
              ...
              <input type="text" id="form1Example13" class="form-control form-control-lg py-3" name="user_name" autocomplete="off" placeholder="enter your e-mail" style="border-radius:25px ;" />
            ...
            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
              <input type="submit" value="Sign in" name="submit" class="btn btn-warning btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600;" />
            </div>
