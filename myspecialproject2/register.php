                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example1c" class="form-control form-control-lg py-3" name="user_name" autocomplete="off" placeholder="enter your name" style="border-radius:25px ;" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example3c" class="form-control form-control-lg py-3" name="user_email" autocomplete="off" placeholder="enter your email" style="border-radius:25px ;" />

                      </div>
                    </div>
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fas fa-calendar-date-fill"></i>
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example4c"><i class="bi bi-chat-left-dots-fill"></i> Date</label>
                        <input type="datetime-local" id="form3Example4c" class="form-control form-control-lg py-3" name="dateuser" autocomplete="off" placeholder="enter your password" style="border-radius:25px ;" />
                      </div>
                    </div>
