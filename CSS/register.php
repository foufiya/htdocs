                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example1c"><i class="bi bi-person-circle"></i> Your UserName</label>
                        <input type="text" id="form3Example1c" class="form-control form-control-lg py-3" name="user_name" autocomplete="off" placeholder="enter your username" style="border-radius:25px ;" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="email" id="form3Example3c" class="form-control form-control-lg py-3" name="user_email" autocomplete="off" placeholder="enter your email" style="border-radius:25px ;" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="datetime-local" id="form3Example1c" class="form-control form-control-lg py-3" name="dateuser" autocomplete="off" placeholder="enter today's date" style="border-radius:25px ;" />
